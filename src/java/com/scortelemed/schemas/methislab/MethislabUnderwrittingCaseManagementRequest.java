...
/**
 * <p>Java class for MethislabUnderwrittingCaseManagementRequest complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="MethislabUnderwrittingCaseManagementRequest">
 *   &lt;complexContent>
...
@XmlType(name = "MethislabUnderwrittingCaseManagementRequest", propOrder = {
    "candidateInformation",
    "previousQuestions",
    "services",
    "benefits"
})
public class MethislabUnderwrittingCaseManagementRequest {

    @XmlElement(name = "CandidateInformation", required = true)
    protected MethislabUnderwrittingCaseManagementRequest.CandidateInformation candidateInformation;
    @XmlElement(nillable = true)
    protected List<MethislabUnderwrittingCaseManagementRequest.PreviousQuestions> previousQuestions;
    @XmlElement(nillable = true)
    protected List<MethislabUnderwrittingCaseManagementRequest.Services> services;
     ...
     * @return
     *     possible object is
     *     {@link MethislabUnderwrittingCaseManagementRequest.CandidateInformation }
     *     
     */
    public MethislabUnderwrittingCaseManagementRequest.CandidateInformation getCandidateInformation() {
     ...
     *     
     */
    public void setCandidateInformation(MethislabUnderwrittingCaseManagementRequest.CandidateInformation value) {
     ...
     * {@link MethislabUnderwrittingCaseManagementRequest.PreviousQuestions }
     * 
     * 
     */
    public List<MethislabUnderwrittingCaseManagementRequest.PreviousQuestions> getPreviousQuestions() {
        if (previousQuestions == null) {
            previousQuestions = new ArrayList<MethislabUnderwrittingCaseManagementRequest.PreviousQuestions>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link MethislabUnderwrittingCaseManagementRequest.Services }
     * 
     * 
     */
    public List<MethislabUnderwrittingCaseManagementRequest.Services> getServices() {
        if (services == null) {
            services = new ArrayList<MethislabUnderwrittingCaseManagementRequest.Services>();
        }
