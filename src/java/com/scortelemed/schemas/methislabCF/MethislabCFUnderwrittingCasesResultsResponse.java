...
public class MethislabCFUnderwrittingCasesResultsResponse {
    ...
    protected List<MethislabCFUnderwrittingCasesResultsResponse.Expediente> expediente;
     ...
     * {@link MethislabCFUnderwrittingCasesResultsResponse.Expediente }
     *
     *
     */
    public List<MethislabCFUnderwrittingCasesResultsResponse.Expediente> getExpediente() {
        if (expediente == null) {
            expediente = new ArrayList<MethislabCFUnderwrittingCasesResultsResponse.Expediente>();
        }
