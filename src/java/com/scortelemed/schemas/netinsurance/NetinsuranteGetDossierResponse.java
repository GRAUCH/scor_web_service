...
/**
 * <p>Java class for netinsuranteGetDossierResponse complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="netinsuranteGetDossierResponse">
 *   &lt;complexContent>
...
@XmlType(name = "netinsuranteGetDossierResponse", propOrder = {
    "date",
    "status",
    "notes",
    "expedienteConsulta"
})
public class NetinsuranteGetDossierResponse {
    ...
    protected List<NetinsuranteGetDossierResponse.ExpedienteConsulta> expedienteConsulta;
     ...
     * {@link NetinsuranteGetDossierResponse.ExpedienteConsulta }
     * 
     * 
     */
    public List<NetinsuranteGetDossierResponse.ExpedienteConsulta> getExpedienteConsulta() {
        if (expedienteConsulta == null) {
            expedienteConsulta = new ArrayList<NetinsuranteGetDossierResponse.ExpedienteConsulta>();
        }
