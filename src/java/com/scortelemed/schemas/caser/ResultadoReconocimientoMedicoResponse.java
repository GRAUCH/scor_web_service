 ...
 *                   &lt;element name="requestState" type="{http://www.scortelemed.com/schemas/caser}RequestStateType"/>
...
public class ResultadoReconocimientoMedicoResponse {
    ...
    protected List<ResultadoReconocimientoMedicoResponse.Expediente> expediente;
    ...
    public List<ResultadoReconocimientoMedicoResponse.Expediente> getExpediente() {
        if (expediente == null) {
            expediente = new ArrayList<ResultadoReconocimientoMedicoResponse.Expediente>();
        }
