 ...
 * 
 * <pre>
 * &lt;complexType name="ReconocimientoMedico">
 *   &lt;complexContent>
...
@XmlType(name = "reconocimientoMedico", propOrder = {
		"candidateInformation", "policyHolderInformation",
		"serviceInformation", "benefitsType" })

public class ReconocimientoMedico {

		@XmlElement(name = "CandidateInformation", required = true)
		protected CandidateInformation candidateInformation;
		@XmlElement(name = "PolicyHolderInformation", required = true)
		protected PolicyHolderInformation policyHolderInformation;
		...
		protected List<BenefitsType> benefitsType;

		/**
		 * Gets the value of the candidateInformation property.
		 * 
		 * @return possible object is {@link CandidateInformation }
		 * 
		 */
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link CandidateInformation }
		 * 
		 */
		public void setCandidateInformation(CandidateInformation value) {
		 ...
		 * 
		 * @return possible object is {@link PolicyHolderInformation }
		 * 
		 */
		 ...
		 * 
		 * @param value
		 *            allowed object is {@link PolicyHolderInformation }
		 * 
		 */
		public void setPolicyHolderInformation(PolicyHolderInformation value) {
		 ...
		 * <CODE>set</CODE> method for the serviceInformation property.
		 * 
		 * <p>
		 ...
		 * snapshot. Therefore any modification you make to the returned list
		 * will be present inside the JAXB object. This is why there is not a
		 * <CODE>set</CODE> method for the benefitsType property.
		 * 
		 * <p>
		 * For example, to add a new item, do as follows:
		 * 
		 ...
		 * 
		 */
		public List<BenefitsType> getBenefitsType() {
			if (benefitsType == null) {
				benefitsType = new ArrayList<BenefitsType>();
			}
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "benefictName", "benefictCode",
				"benefictCapital" })
		public static class BenefitsType {
			 ...
			 * 
			 * @return possible object is {@link BenefictNameType }
			 * 
			 */
			 ...
			 * 
			 * @param value
			 *            allowed object is {@link BenefictNameType }
			 * 
			 */
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "fiscalIdentificationNumber", "name",
				"surname", "address", "city", "province", "country",
				"postalCode", "email", "gender", "civilState", "mobileNumber",
				"phoneNumber1", "phoneNumber2", "password", "igp", "agente",
				"productCode", "birthDate", "operationType" })
		public static class CandidateInformation {
			 ...
			 * 
			 * @return possible object is {@link CivilStateType }
			 * 
			 */
			 ...
			 * 
			 * @param value
			 *            allowed object is {@link CivilStateType }
			 * 
			 */
		...
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "fiscalIdentificationNumber", "name",
				"surname1", "surname2", "policyNumber", "certificateNumber",
				"requestDate", "requestNumber", "comments" })
		 ...
		 */
		@XmlAccessorType(XmlAccessType.FIELD)
		@XmlType(name = "", propOrder = { "serviceType", "serviceCode",
				"serviceDescription" })
