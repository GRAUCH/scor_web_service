...
public enum DatosLifesquareEnum {
	product("product",25),
	...
	fiscal_identification_number("fiscal_identification_number",12),
	agent("agent",8),
	...
	euw_code("euw_code",30),
	activate_profession("activate_profession",30),
	activate_sport("activate_sport",30),
	activate_oblivion("activate_oblivion",30);
	
	private final String valor;
	private final int tamanio;
	
	DatosLifesquareEnum(String value,int tamanio) { 
		this.valor = value; 
