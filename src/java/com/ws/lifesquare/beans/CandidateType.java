...
import com.ws.enumeration.ClientTypeLifesquare;
import com.ws.enumeration.ContactTimeLifesquareType;
...
public class CandidateType implements Serializable {
	...
	@XmlElement(nillable=true)
	private ContactTimeLifesquareType contact_time;
	@XmlElement(nillable=true)
	private ClientTypeLifesquare client_type;
	...
	public ContactTimeLifesquareType getContact_time() {
		return contact_time;
	}
	public void setContact_time(ContactTimeLifesquareType contact_time) {
		this.contact_time = contact_time;
	}
	public ClientTypeLifesquare getClient_type() {
		return client_type;
	}
	public void setClient_type(ClientTypeLifesquare client_type) {
