...
@XmlType(name = "LifesquareUnderwrittingCaseManagementRequest", propOrder = {
    "request_Data",
    "policy",
    "candidate",
    "agent"
...
@XmlRootElement(name = "LifesquareUnderwrittingCaseManagementRequest")
public class LifesquareUnderwrittingCaseManagementRequest implements Serializable {
	/**
	 * 
	 */
