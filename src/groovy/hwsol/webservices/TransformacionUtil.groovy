...
class TransformacionUtil {
	...
	public String obtenerCodigoCajamar(String codigoCrm, String codigoProducto){
		...
		def codigoCajamar
			...
			case "TPC02":
				if (codigoCrm.equals("COB215")){codigoCajamar = "21001"}
				if (codigoCrm.equals("COB216")){codigoCajamar = "21003"}
				if (codigoCrm.equals("COB220")){codigoCajamar = "21007"}
				if (codigoCrm.equals("COB223")){codigoCajamar = "21009"}
			break
			case "TPC05":
				if (codigoCrm.equals("COB215")){codigoCajamar = "21001"}
				if (codigoCrm.equals("COB216")){codigoCajamar = "21003"}
			...
			break
			case "TRA01":
				if (codigoCrm.equals("COB212")){codigoCajamar = "703"}
				if (codigoCrm.equals("COB217")){codigoCajamar = "201"}
				if (codigoCrm.equals("COB220")){codigoCajamar = "401"}
				if (codigoCrm.equals("COB221")){codigoCajamar = "702"}
				if (codigoCrm.equals("COB223")){codigoCajamar = "703"}
			break
			case "TRA02":
				if (codigoCrm.equals("COB217")){codigoCajamar = "201"}
				if (codigoCrm.equals("COB221")){codigoCajamar = "702"}
			...
			case "TRA08":
				if (codigoCrm.equals("COB212")){codigoCajamar = "703"}
				if (codigoCrm.equals("COB217")){codigoCajamar = "201"}
				if (codigoCrm.equals("COB213")){codigoCajamar = "10001"}
				if (codigoCrm.equals("COB214")){codigoCajamar = "10002"}
				if (codigoCrm.equals("COB218")){codigoCajamar = "301"}
				if (codigoCrm.equals("COB219")){codigoCajamar = "302"}
				if (codigoCrm.equals("COB220")){codigoCajamar = "401"}
				if (codigoCrm.equals("COB221")){codigoCajamar = "702"}
				if (codigoCrm.equals("COB223")){codigoCajamar = "703"}
			break
	...
	def public int calcularEdad(Date birthdate) {
