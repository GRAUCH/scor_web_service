...
class RequestmapController {
	...
	def show = {
		...
		if (!requestmap) {
			flash.message = "Requestmap no encontrado con id $params.id"
	...
	def delete = {
		...
		flash.message = "Requestmap $params.id borrado."
		redirect(action: list)
	}
	...
	def update = {
		...
		if (requestmap.version > version) {
			requestmap.errors.rejectValue 'version', "requestmap.optimistic.locking.failure",
				"Otro usuario a actuliazado este Requestmap mientras estabas editando."
