    ...
    def index(params) {
        try {
            ...
            if (flash.message != null && params.idCia != null && params.idCia.toString().isEmpty()) {
                ...
                company = Company.findById(params.idCia.split('-')[0])
            }
            ...
            if (params.logs == null || company == null) {
                ...
                elementos = recibidos.obtener(company, desde, hasta, params.max)
                ...
                elementos = errores.obtener(company, desde, hasta, params.max)
