...
class DashboardController {
    ...
    def index(params) {
        ...
        if (params.logs == null) {
            [ciasLog: ciasLog, company: nombre, elementos: elementos, vista: "recibido.gsp", ou: ou, desde: formatter.format(desde), hasta: formatter.format(hasta), max: params.max, lista: null, idCia: idCia]
