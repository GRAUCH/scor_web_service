...
class PaginadorAjaxTagLib {
	...
	def remoteSortableColumn = { attrs ->
		...
		// HACKSAM! PARA USARLO CON EL PAGINADOR Y QUE NO PIERDA LA PAGINA POR LA QUE ESTA :D !
		if(params.offset) linkParams.put("offset",params.offset)
