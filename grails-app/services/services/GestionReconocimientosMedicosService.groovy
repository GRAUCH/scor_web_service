...
import com.ws.lagunaro.beans.DictamenType;
import com.ws.lagunaro.beans.Garantia
import com.ws.lagunaro.beans.GestionReconocimientoMedicoRequest
import com.ws.lagunaro.beans.GestionReconocimientoMedicoResponse
import com.ws.lagunaro.beans.PolizaBasicaGroup
import com.ws.lagunaro.beans.Prueba_Medica
import com.ws.lagunaro.beans.ReconocimientoMedicoTramitacionType
import com.ws.lagunaro.beans.TramitacionReconocimientoMedicoRequest
import com.ws.lagunaro.beans.TramitacionReconocimientoMedicoResponse
		...
		try{
			...
			if (operacion && operacion.activo){
				...
				listaExpedientes.each {
					...
					envio.setInfo("Peticion realizada para fecha: " + tramitacionReconocimientoMedicoRequest.fecha + " poliza " + polizaBasicaGroup.cod_poliza + ", certificado: " + polizaBasicaGroup.certificado + " mofivimiento " + polizaBasicaGroup.movimiento)
