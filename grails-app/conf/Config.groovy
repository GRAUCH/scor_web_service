		...
		development {
			...
			appenders {
				...
				appender new DailyRollingFileAppender(
						...
						datePattern: "'.'yyyy-MM-dd",
						threshold: org.apache.log4j.Level.INFO,
						fileName: '/home/webapps/logs/prepro/webservices/scorWebserviceInfo.log',  //storage path of log file
						layout: pattern(conversionPattern:'%d [%t] %-5p %c{2} %x - %m%n')
						)
				appender new DailyRollingFileAppender(
						name: 'errorAppender',
						datePattern: "'.'yyyy-MM-dd",
						threshold: org.apache.log4j.Level.ERROR,
						fileName: '/home/webapps/logs/prepro/webservices/scorWebserviceError.log',  //storage path of log file
						layout: pattern(conversionPattern:'%d [%t] %-5p %c{2} %x - %m%n')
						)
			}
