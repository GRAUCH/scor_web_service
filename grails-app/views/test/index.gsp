		...
		<div id="list-test" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="nombre" title="${message(code: 'test.nombre.label', default: 'Nombre')}" />
				...
				<g:each in="${testInstanceList}" status="i" var="testInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${testInstance.id}">${fieldValue(bean: testInstance, field: "nombre")}</g:link></td>
