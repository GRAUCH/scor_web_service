		...
		<div id="show-test" class="content scaffold-show" role="main">
			...
			<ol class="property-list test">
				...
				<li class="fieldcontain">
					<span id="nombre-label" class="property-label"><g:message code="test.nombre.label" default="Nombre" /></span>
					
						<span class="property-value" aria-labelledby="nombre-label"><g:fieldValue bean="${testInstance}" field="nombre"/></span>
