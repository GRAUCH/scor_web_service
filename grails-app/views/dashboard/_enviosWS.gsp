...
<g:form method="post" controller="ws" action="caseresult">
    <div id="panelalptis"
        ...
        <div id="busqFecha0">
            <div style="float:left; margin: auto;  padding-right:20px;">
                Desde <p>
                <g:datePicker name="ini" value="${new Date()}" precision="hour"
                              noSelection="['': '-Choose-']" />
            </p>
            </div>
            <div style="float:left; margin: auto;  padding-right:20px;">
                Hasta <p>
                <g:datePicker name="fin" value="${new Date()}" precision="hour"
                              noSelection="['': '-Choose-']" />
            </p>
            </div>
        </div>
...
<g:form method="post" controller="ws" action="caseresultCaser">
    <div id="panelcaser"
        ...
        <div style="margin-top: 18px;">
            <g:submitButton name="create" class="btn btn-blue" value="Forzar Envio CASER" />
        </div>
