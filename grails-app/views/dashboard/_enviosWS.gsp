...
<body>
    ...
    <g:form method="post" controller="ws" action="caseresult">
        ...
        <div id="panelAlptis"  style=" width: 950px; padding: 20px; float: left; border-top-style: solid; border-width: 1px; border-color: #ADADAD;">
            ...
            <div style="float:left; margin: auto;  padding-right:20px;"  >
                <label for="requestNumber">Envio por Fecha</label>
            </div>
            ...
            <div style=" margin-left: 15px; padding-bottom: 10px;"  >
                <label for="requestNumber">Envio por Numero de Caso</label>
    ...
    <g:form method="post" controller="ws" action="caseresultAma">
        <div id="panelAma" style=" width: 950px; padding: 20px; float: left; border-top-style: solid; border-width: 1px; border-color: #ADADAD;">
    ...
    <g:form method="post" controller="ws" action="caseresultCaser">
        <div id="panelCaser" style=" width: 950px; padding: 20px; float: left; border-top-style: solid; border-width: 1px; border-color: #ADADAD;">
    ...
    <g:form method="post" controller="ws" action="caseresultCM">
        ...
        <div id="panelCajamar" style=" width: 950px; padding: 20px; float: left; border-top-style: solid; border-width: 1px; border-color: #ADADAD;">
